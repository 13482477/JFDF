...
<div class="row">
	<div class="col-md-12">
		<div class="box box-primary">
			<div class="box-header with-border">角色列表</div>
			<div class="box-body">
				<div id="searchBar" class="form-inline" role="form">
					<div class="form-group">
						<span><strong>角色名称: </strong></span><input id="roleName" name="resourceName" class="form-control input-sm" type="text">
					</div>
					<div class="form-group">
						<span><strong>角色代码: </strong></span><input id="roleCode" name="resourceCode" class="form-control input-sm" type="text">
					</div>
					<div class="form-group">
				...
				<div id="toolbar">
					<div class="form-inline" role="form">
						...
						<div class="form-group">
							<a href="javascript: void(0);" id="authorizationButton" class="btn btn-info btn-flat btn-sm" title="授权">
